...
export function IncidentDetailScreen({ route }: RootStackScreenProps<"IncidentDetail">) {
  ...
  const regenerate = async () => {
    ...
    try {
      ...
      // Generation is local and has nothing to configure, so the old 503
      // ("no ANTHROPIC_API_KEY") is no longer reachable. Anything arriving
      // here is a real server or network failure, and a person who pressed a
      // button still learns it did not happen — surfaced, not swallowed.
      setRegenerateError(
